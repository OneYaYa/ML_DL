# -*- coding: utf-8 -*-
"""“DL_homework5.ipynb”的副本

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1dvqDHSSnnQRShgrvyEWvkyDMHCly97f2
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim, hid_dim = 400, output_dim = 784):
        ...
        # Define the necessary fully-connected transformations
        self.fc1 = nn.Linear(latent_dim, hid_dim)
...
# define optimizer
optimizer = torch.optim.Adam(vae.parameters(), lr=adam_step_size)
###############################
...
for epoch in range(epochs):
    ...
    for x, _ in dataloader:
        ...
        ### YOUR SOLUTION GOES HERE ###  (2 Points)
        x_recon, mu, log_std = vae(x)
        loss = vae_loss(x_recon, x, mu, log_std)
...
samples = vae.sample(n_samples).cpu().detach()
###############################
